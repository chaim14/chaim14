...
import Box from './view/conponents/Box';
import './view/conponents/styles/global.scss';
...
// }
  return (
    <div className="App">
      ...
      <a>atar sfarim</a>
        {boxes.map((box, i)=>{ return <Box key={i} text={box.text} price={box.price} img={box.img} />})}
      </header>
    </div>
  );
}
